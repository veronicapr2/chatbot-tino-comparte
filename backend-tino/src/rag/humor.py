...
HUMOR_RESPONSES: tuple[str, ...] = (
    ...
    "Tino en modo chanza: 100 % activado. Modo serio y útil: también disponible cuando lo necesites.",
    ...
    "Mis alitas no prometen stand-up, pero sí buena intención. ¿Seguimos en serio o en chanza?",
    ...
    "¿Sabes qué es sorpresa? Que una buena idea aparezca justo después de reírse un poco.",
    "Modo broma activado. Modo orientación: en espera, como un mentor puntual.",
    ...
    "¿Por qué soy bueno en chistes cortos? Porque las mejores ideas caben en una servilleta.",
    "Tu mensaje tenía vibra de chanza. Aquí va otra: ¿qué hace una idea en su día libre? Buscar clientes.",
    ...
    "¿Sabes qué sorprende a Tino? Que preguntes por chistes y no por impuestos. Eso sí es plot twist.",
    "Aquí hay humor; cuando quieras, también hay orientación para emprender. Equilibrio emprendedor.",
    ...
    "Último chiste del lote (casi): Tino no duerme, pero sí hace pausas entre chistes y orientación.",
